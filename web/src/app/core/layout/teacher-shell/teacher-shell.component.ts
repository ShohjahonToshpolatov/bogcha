...
export class TeacherShellComponent {
  ...
  readonly navItems: NavItem[] = [
    { path: '/teacher/today', icon: 'today', labelKey: 'nav.today' },
    { path: '/teacher/children', icon: 'groups', labelKey: 'nav.children' },
    { path: '/teacher/feed', icon: 'add_a_photo', labelKey: 'nav.feed' },
    { path: '/teacher/messages', icon: 'chat', labelKey: 'nav.messages' },
    { path: '/teacher/me', icon: 'person', labelKey: 'nav.me' },
  ];
}
